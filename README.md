...
The app uses a local SQLite database for offline Raspberry Pi deployments.
...
```powershell
$env:TCM_DB_PATH='D:\tcm-data\tcm_diagnosis.sqlite3'
```
...
The SQLite file is ignored by Git so private user data is not pushed to GitHub.
